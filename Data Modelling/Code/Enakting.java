...
public class Enakting {
	...
	public static void main(String[] args) {
		...
		try {
			workbook = Workbook.getWorkbook(new File("BusinessImpactsOfCovid19Data_cleaned.xls"));
		...
		ArrayList<Hashtable<String, ArrayList<String>>> wkBookSheetContents = enakting.get(workbook,2,0,3,1,18,2);
		System.out.println(wkBookSheetContents);

		// set up the DataSet objects
		DataSet[] allIndustries = new DataSet[17];
		for(int i = 0; i < allIndustries.length; i++) {
			allIndustries[i] = new DataSet();
		}
		// the lines here fill in data into the DataSet objects
		...
		try {
			...
			//Table2------------------------------------------------------------------------------------------------------------
			wkBookSheetContents = enakting.get(workbook,2,0,4,21,23,22);
			System.out.println(wkBookSheetContents);
		...
		//Table3------------------------------------------------------------------------------------------------------------
			wkBookSheetContents = enakting.get(workbook,3,0,3,1,15,2);
		System.out.println(wkBookSheetContents);


		// set up the 2 DataSet objects
		allIndustries = new DataSet[13];
		for(int i = 0; i < allIndustries.length; i++) {
			allIndustries[i] = new DataSet();
		}
		...
		//Table4------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,3,0,4,19,21,20);
		System.out.println(wkBookSheetContents);
		...
		//Table5------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,3,6,9,1,15, 2);
		System.out.println(wkBookSheetContents);
		...
		//Table6------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,3,6,10,19,21, 20);
		System.out.println(wkBookSheetContents);
		...
		//Table7------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,4,0,3,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		//Table8------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,4,0,3,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		//Table9------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,4,0,3,25,31,26);
		System.out.println(wkBookSheetContents);
		...
		//Table10------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,5,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = enakting.get(workbook,5,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = enakting.get(workbook,5,0,7,25,31,26);
		System.out.println(wkBookSheetContents);
		...
		//Table13-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,6,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = enakting.get(workbook,6,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		//Table15-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,7,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		//Table16-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = enakting.get(workbook,7,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
