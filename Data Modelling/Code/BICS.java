...
public class BICS {
	...
	public static void main(String[] args) {
		...
		BICS bics = new BICS();
		ArrayList<Hashtable<String, ArrayList<String>>> wkBookSheetContents = bics.get(workbook,2,0,3,1,18,2);
		...
		try {
			...
			//Table2------------------------------------------------------------------------------------------------------------
			wkBookSheetContents = bics.get(workbook,2,0,4,21,23,22);
			System.out.println(wkBookSheetContents);
		...
		//Table3------------------------------------------------------------------------------------------------------------
			wkBookSheetContents = bics.get(workbook,3,0,3,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		//Table4------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,3,0,4,19,21,20);
		System.out.println(wkBookSheetContents);
		...
		//Table5------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,3,6,9,1,15, 2);
		System.out.println(wkBookSheetContents);
		...
		//Table6------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,3,6,10,19,21, 20);
		System.out.println(wkBookSheetContents);
		...
		//Table7------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,4,0,3,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		//Table8------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,4,0,3,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		//Table9------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,4,0,3,25,31,26);
		System.out.println(wkBookSheetContents);
		...
		//Table10------------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,5,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = bics.get(workbook,5,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = bics.get(workbook,5,0,7,25,31,26);
		System.out.println(wkBookSheetContents);
		...
		//Table13-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,6,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		wkBookSheetContents = bics.get(workbook,6,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
		...
		//Table15-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,7,0,7,1,15,2);
		System.out.println(wkBookSheetContents);
		...
		//Table16-----------------------------------------------------------------------------------------------------------
		wkBookSheetContents = bics.get(workbook,7,0,7,18,22,19);
		System.out.println(wkBookSheetContents);
